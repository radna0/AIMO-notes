...
app = modal.App("example-eval-vllm-notebook")
...
vllm_image = (
    ...
    .add_local_file("data/reference.csv", remote_path="/root/reference.csv")
)
...
def run():
    ...
    sample_and_predict("reference.csv")
    ...
    if (
        ...
        if not incorrect_df.empty:
            ...
            print(incorrect_df[["id", "question", "answer_ref", "answer_pred"]])
        else:
