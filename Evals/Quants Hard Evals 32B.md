...
python eval_turbomind.py --model radna/FuseO1-DeepSeek-R1-QwQ-SkyT1-32B-Preview-AWQ --file hard_batch_1.csv --num_seqs 8 --tokens 12288 --quant_policy 0 --min_p 0.10 (Practically Tested 28/50)
